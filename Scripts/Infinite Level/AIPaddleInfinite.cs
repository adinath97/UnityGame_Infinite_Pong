...
public class AIPaddleInfinite : MonoBehaviour
{
    float d, xPos, deltaX, direction, scale, xMin, yMin, xMax, yMax, subFactor;
    Vector3 move = Vector3.zero;
    public static bool pickChasingSpotInfinite;
    public bool startMovingInfinite;
    int rand1;
    ...
    void Start() {
        ...
        xMin = -13.2f;
        xMax = 10.9f;
        startMovingInfinite = false;
        moveSpeed = 10f;
        pickChasingSpotInfinite = true;
    }
    ...
    {
        //MovePlayer();
        if(startMovingInfinite && LevelManagerInfinite.ballMovingUpInfinite) {
            if(pickChasingSpotInfinite) {
                pickChasingSpotInfinite = false;
